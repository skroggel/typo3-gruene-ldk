...
import {buildAssets} from './tasks/assets.mjs';
...
import {watchScripts, watchStyles, watchAssets} from "./tasks/watch.mjs";
...
gulp.task(
  "watch",
  gulp.series(cleanAll, "build", gulp.parallel(watchAssets, watchStyles, watchScripts))
);
